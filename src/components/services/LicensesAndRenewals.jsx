            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-200 to-gray-300 rounded-lg overflow-hidden shadow-xl h-[550px] flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-gray-600 font-medium">License & Certification</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">Submission</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="border border-gray-200 p-6 rounded-lg hover:shadow-lg transition-shadow">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Healthcare Facility Licensing</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="border border-gray-200 p-6 rounded-lg hover:shadow-lg transition-shadow">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Hospital Licensing and Renewal</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="border border-gray-200 p-6 rounded-lg hover:shadow-lg transition-shadow">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Professional License Renewal</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="border border-gray-200 p-6 rounded-lg hover:shadow-lg transition-shadow">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Specialty Healthcare Licensing</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="border border-gray-200 p-6 rounded-lg hover:shadow-lg transition-shadow">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Licensing Compliance Audits</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 rounded-lg h-80 flex items-center justify-center backdrop-blur-sm">
              <div className="text-center p-6">
                ...
                <p className="text-white/90 text-sm">Licensed & Certified</p>
              </div>
            </div>
            <div>
              <h2 className="text-3xl font-bold mb-6">Your Licensing Partner, Every Step Of The Way</h2>
